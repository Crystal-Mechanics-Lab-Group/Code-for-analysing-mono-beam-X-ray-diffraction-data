...
for depth=0:30
    ...
    %peak354
    str1 = 'W1Re3000He_111\peak354\depth';
    i= d354 + depth;
    ...
    %peak435
    str1 = 'W1Re3000He_111\peak435\depth';
    i= d435 + depth;
    s = strcat(str1,num2str(i));
    cd (s);
    Q3D = dlmread('Qspace3D.txt');
    ...
    %peak471
    str1 = 'W1Re3000He_111\peak471\depth';
    i= d471 + depth;
    s = strcat(str1,num2str(i));
    cd (s);
    Q3D = dlmread('Qspace3D.txt');
    ...
    %peak804
    str1 = 'W1Re3000He_111\peak804\depth';
    i= d804 + depth;
    s = strcat(str1,num2str(i));
    cd (s);
    Q3D = dlmread('Qspace3D.txt');
    ...
    %peak635
    str1 = 'W1Re3000He_111\peak635\depth';
    i= d635 + depth;
    s = strcat(str1,num2str(i));
    cd (s);
    Q3D = dlmread('Qspace3D.txt');
    ...
    %peak554
    str1 = 'W1Re3000He_111\peak554\depth';
    i= d554 + depth;
    s = strcat(str1,num2str(i));
    cd (s);
    Q3D = dlmread('Qspace3D.txt');
